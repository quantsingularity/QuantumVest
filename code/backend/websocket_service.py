...
from models import User, Portfolio, Asset, PriceData, Alert, db
...
class WebSocketService:
    ...
    def __init__(self, socketio: SocketIO):
        ...
        self.connected_users: Dict[str, str] = {}  # session_id -> user_id
        self.user_rooms: Dict[str, Set[str]] = {}  # user_id -> set of room names
        self.price_subscribers: Dict[str, Set[str]] = {}  # asset_symbol -> set of user_ids
    ...
    def register_handlers(self):
        ...
        def handle_connect(auth):
            ...
            try:
                ...
                if not user or not user.is_active:
                    logger.warning(f"WebSocket connection attempted for inactive user: {user_id}")
                    return False
        ...
        def handle_subscribe_portfolio(data):
            ...
            try:
                ...
                emit('portfolio_subscription_confirmed', {
    ...
    def broadcast_portfolio_update(self, portfolio_id: str, update_data: Dict):
    ...
    def broadcast_market_alert(self, alert_data: Dict):
        ...
        try:
            ...
            logger.info(f"Broadcasted market alert: {alert_data.get('title', 'Unknown')}")
    ...
    async def start_price_streaming(self):
        ...
        while self.is_running:
            try:
                ...
                subscribed_symbols = set(self.websocket_service.price_subscribers.keys())
                
                if subscribed_symbols:
                    # Fetch latest prices (this would typically call external APIs)
