...
from auth import token_required, premium_required, rate_limit, AuthService
from portfolio_service import PortfolioService
from models import User, Portfolio, Asset, Watchlist, WatchlistItem, Alert, db
...
def update_profile(current_user):
    ...
    try:
        ...
        allowed_fields = ['first_name', 'last_name', 'phone', 'risk_tolerance', 
                         'investment_experience', 'preferred_currency']
...
def get_portfolio_details(current_user, portfolio_id):
    ...
    try:
        ...
        return jsonify({'success': False, 'error': 'Failed to get portfolio details'}), 500
...
def get_portfolio_performance(current_user, portfolio_id):
    ...
    try:
        ...
        return jsonify({'success': False, 'error': 'Failed to get portfolio performance'}), 500
