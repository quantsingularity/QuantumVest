...
describe('Toast Component', () => {
    ...
    test('renders different toast types correctly', () => {
        ...
        const { rerender } = render(
            <Toast message="Info toast" type="info" onClose={mockOnClose} autoClose={false} />,
        );
        ...
        expect(screen.getByText('Success toast').closest('.toast-container')).toHaveClass(
            'success',
        );
        ...
        expect(screen.getByText('Warning toast').closest('.toast-container')).toHaveClass(
            'warning',
        );

        rerender(
            <Toast message="Error toast" type="error" onClose={mockOnClose} autoClose={false} />,
        );
