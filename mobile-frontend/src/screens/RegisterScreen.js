...
import { TextInput, Button, Text, useTheme, Card, HelperText } from 'react-native-paper';
import { useAuth } from '../context/AuthContext';
import { showErrorAlert, validateEmail, validatePassword } from '../utils/errorHandler';
...
const RegisterScreen = ({ navigation }) => {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            if (!result.success) {
                showErrorAlert(result.error || 'Registration failed', 'Registration Error');
            }
        } catch (error) {
